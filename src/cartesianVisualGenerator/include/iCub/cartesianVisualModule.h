...
class cartesianVisualModule:public yarp::os::RFModule {
    ...
    /*  */
    cartesianVisualThread *rThread;                 // pointer to a new thread to be created and started in configure() and stopped in close()
